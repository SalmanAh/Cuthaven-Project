...
function ShopPage() {
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-7xl px-3 sm:px-4 py-8 sm:py-10 grid lg:grid-cols-[280px_1fr] gap-6 sm:gap-8">
        ...
        <div>
          ...
          <div className="relative mb-4 sm:mb-5">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-3.5 w-3.5 sm:h-4 sm:w-4 text-text-secondary pointer-events-none" />
            <input
              type="search"
              value={searchQ}
              onChange={(e) => {
