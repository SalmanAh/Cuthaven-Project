  ...
  head: () => ({
    meta: [
      { title: "About CutHaven — Our Story" },
      {
        name: "description",
        content:
          "CutHaven is your trusted source for premium outdoor and garden tools. Learn about our mission and values.",
      },
    ...
    <div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold mt-2 mb-5">
            Built by tool people, for tool people.
          </h2>
          <div className="space-y-4 text-text-secondary leading-relaxed">
            <p>
              At CutHaven, we source premium outdoor, garden, hand, and power tools from
              manufacturers we actually trust. Every product we carry is one we'd use ourselves — no
              filler, no gimmicks.
            </p>
            <p>
              We ship from the US, back every order with a 40-day return window, and answer support
              emails from real people during business hours.
            </p>
            <p>
              Whether you're prepping a garden, rebuilding a deck, or repowering a machine, we want
              you to get the right tool the first time.
            </p>
          </div>
        ...
        <div className="aspect-square rounded-2xl overflow-hidden bg-muted relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white">
              <h3 className="font-display text-3xl md:text-4xl font-bold drop-shadow-lg">
                CutHaven Workshop
              </h3>
              <p className="text-sm md:text-base mt-2 text-white/90 drop-shadow">
                Premium Tools, Organized Excellence
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-primary text-primary-foreground py-16 text-center">
        <div className="mx-auto max-w-3xl px-4">
          <p className="text-primary-foreground/70 text-sm uppercase tracking-widest font-semibold">
            Our Mission
          </p>
          <h2 className="font-display text-3xl md:text-4xl font-bold mt-2 mb-4">
            Right tool. Right price. Right support.
          </h2>
          <p className="text-primary-foreground/85 leading-relaxed">
            We believe buying a tool shouldn't feel like a gamble. Our mission is to make quality
            tools accessible, backed by honest advice and dependable service — so every project
