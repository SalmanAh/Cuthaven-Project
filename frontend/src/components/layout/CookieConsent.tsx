...
function getSessionId(): string {
  try {
    ...
    if (!id) {
      ...
      sessionStorage.setItem("ch-session-id", id);
    }
    return id;
  } catch {
    return "unknown";
          ...
          <div className="space-y-4 py-2">
            <label className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-text-secondary">Required for the site to function.</p>
              </div>
            ...
            <label className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-text-secondary">
                  Personalize ads and measure their performance.
                </p>
              </div>
