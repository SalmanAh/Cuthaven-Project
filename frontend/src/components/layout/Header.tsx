...
export function Header() {
  ...
  return (
    <>
      ...
      <header
        className={`sticky top-0 z-40 bg-surface transition-shadow ${scrolled ? "shadow-md" : "shadow-sm"}`}
      >
          ...
          <div className="flex items-center gap-1 sm:gap-2 md:gap-3">
            ...
            >
              ...
              <span className="hidden xl:inline text-xs text-text-secondary whitespace-nowrap">
                {count} items —{" "}
                <span className="text-accent font-semibold">${subtotal.toFixed(2)}</span>
              </span>
            </button>
      ...
      {searchOpen && (
        <div className="fixed inset-0 z-50 bg-black/60" onClick={() => setSearchOpen(false)}>
          <div
            className="bg-surface w-full py-6 sm:py-8 px-3 sm:px-4"
            ...
            <div className="mx-auto max-w-3xl">
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <button
                    type="submit"
                    className="btn-primary text-xs sm:text-sm px-3 sm:px-4 py-2 shrink-0"
                  >
                    Search
                  </button>
                  <button
              ...
              <div className="mt-4 sm:mt-6">
                <p className="text-[10px] sm:text-xs uppercase tracking-wide text-text-secondary mb-2 sm:mb-3">
                  Popular searches
                </p>
