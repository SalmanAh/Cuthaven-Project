...
function CookiePrefsLink() {
  ...
  return (
    <button onClick={openCookiePrefs} className="underline hover:text-white">
      Cookie Preferences
    </button>
  );
}
    ...
    <footer className="mt-16 sm:mt-20">
      ...
      <div className="bg-[#1A1A1A] text-white">
        <div className="mx-auto max-w-7xl px-3 sm:px-4 py-10 sm:py-14 grid gap-8 sm:gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <div className="flex gap-2.5 sm:gap-3">
              {[Facebook, Instagram, Twitter, Linkedin].map((Icon, i) => (
                <a
                  ...
                  href="#"
                  className="h-8 w-8 sm:h-9 sm:w-9 rounded-full border border-white/20 flex items-center justify-center hover:bg-primary hover:border-primary transition-colors"
                >
          ...
          <div>
            <h4 className="font-display text-base sm:text-lg text-primary-light mb-3 sm:mb-4">
              Categories
            </h4>
              ...
              {topCategories.map((cat) => (
                <li key={cat.id}>
                  <Link
                    ...
                    className="hover:text-white inline-block py-0.5"
                  >
                    {cat.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-2.5 text-xs sm:text-sm text-white/80">
              <li>
                <Link to="/privacy-policy" className="hover:text-white inline-block py-0.5">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/returns-refund-policy" className="hover:text-white inline-block py-0.5">
                  Returns &amp; Refund Policy
                </Link>
              </li>
              <li>
                <Link to="/shipping-policy" className="hover:text-white inline-block py-0.5">
                  Shipping Policy
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/terms-of-service" className="hover:text-white inline-block py-0.5">
                  Terms of Service
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-2.5 text-xs sm:text-sm text-white/80">
              <li>
                <Link to="/about-us" className="hover:text-white inline-block py-0.5">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/account/dashboard" className="hover:text-white inline-block py-0.5">
                  My Account
                </Link>
              </li>
              <li>
                <Link to="/track-your-order" className="hover:text-white inline-block py-0.5">
                  Track Your Order
                </Link>
              </li>
              <li>
                <Link to="/contact-us" hash="faqs" className="hover:text-white inline-block py-0.5">
                  FAQs
                </Link>
              </li>
              <li>
                <Link to="/blog" className="hover:text-white inline-block py-0.5">
                  Blog
                </Link>
              </li>
              <li>
                <Link to="/contact-us" className="hover:text-white inline-block py-0.5">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-white/80">
              <li className="flex gap-2">
                <MapPin className="h-3.5 w-3.5 sm:h-4 sm:w-4 mt-0.5 shrink-0 text-primary-light" />
                <span className="break-words">1633 S Industrial Way, Palmer, AK 99645</span>
              </li>
              <li className="flex gap-2">
                <Mail className="h-3.5 w-3.5 sm:h-4 sm:w-4 mt-0.5 shrink-0 text-primary-light" />
                <a href="mailto:support@cuthaven.com" className="hover:text-white break-all">
                  support@cuthaven.com
                </a>
              </li>
              <li className="flex gap-2">
                <Phone className="h-3.5 w-3.5 sm:h-4 sm:w-4 mt-0.5 shrink-0 text-primary-light" />
                <a href="tel:+14062299045" className="hover:text-white">
                  +1 (406) 229-9045
                </a>
              </li>
            </ul>
          ...
          <div className="mx-auto max-w-7xl px-3 sm:px-4 py-6 sm:py-8 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div>
              ...
              <p className="text-xs sm:text-sm text-white/70">
                Deals, guides, and new arrivals — no spam.
              </p>
            </div>
            <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                type="submit"
                className="btn-primary text-xs sm:text-sm px-4 sm:px-6 shrink-0"
        ...
        <div className="border-t border-white/10">
          <div className="mx-auto max-w-7xl px-3 sm:px-4 py-4 sm:py-5 flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4 text-[10px] sm:text-xs text-white/60">
            <p className="text-center md:text-left">
              © 2025 CutHaven. All Rights Reserved. · <CookiePrefsLink />
            </p>
            <div className="flex gap-1.5 sm:gap-2 items-center flex-wrap justify-center">
              ...
              <div className="px-2 sm:px-2.5 py-1 sm:py-1.5 rounded bg-white flex items-center justify-center h-6 sm:h-7 min-w-[40px] sm:min-w-[45px]">
                <span className="font-bold text-[#1A1F71] text-xs sm:text-sm tracking-tight">
                  VISA
                </span>
              </div>
              ...
              {/* PayPal */}
              <div className="px-2 sm:px-2.5 py-1 sm:py-1.5 rounded bg-white flex items-center justify-center h-6 sm:h-7 min-w-[40px] sm:min-w-[45px]">
                <span className="font-bold text-[#003087] text-[10px] sm:text-xs tracking-tight">
                  Pay
                </span>
                <span className="font-bold text-[#009CDE] text-[10px] sm:text-xs tracking-tight">
                  Pal
                </span>
              </div>
              ...
              <div className="px-2 sm:px-2.5 py-1 sm:py-1.5 rounded bg-[#006FCF] flex items-center justify-center h-6 sm:h-7 min-w-[40px] sm:min-w-[45px]">
                <span className="font-bold text-white text-[9px] sm:text-[10px] tracking-tight">
                  AMEX
                </span>
              </div>
              ...
              {/* Discover */}
              <div className="px-2 sm:px-2.5 py-1 sm:py-1.5 rounded bg-white flex items-center justify-center h-6 sm:h-7 min-w-[40px] sm:min-w-[45px]">
                <span className="font-bold text-[#FF6000] text-[8px] sm:text-[9px] tracking-tight">
                  DISCOVER
                </span>
              </div>
              ...
              {/* Apple Pay */}
              <div className="px-2 sm:px-2.5 py-1 sm:py-1.5 rounded bg-white flex items-center justify-center h-6 sm:h-7 min-w-[40px] sm:min-w-[45px]">
                <span className="font-semibold text-black text-[9px] sm:text-[10px]">
                  Apple Pay
                </span>
              </div>
