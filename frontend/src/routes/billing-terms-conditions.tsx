...
export const Route = createFileRoute("/billing-terms-conditions")({
  head: () => ({ meta: [{ title: "Billing Terms — CutHaven" }, { name: "description", content: "Billing terms and accepted payment methods at CutHaven." }] }),
  component: () => (
    <PolicyLayout title="Billing Terms & Conditions" crumb="Billing">
      ...
      <h2>Currency</h2>
      <p>All prices are listed in <strong>US Dollars (USD)</strong>.</p>

      <h2>Sales Tax</h2>
      <p>Sales tax is applied where required by law and is displayed at checkout before you complete your order.</p>
      ...
      <p>If there's an issue with your order, please contact <a href="mailto:support@cuthaven.com">support@cuthaven.com</a> first — most disputes are resolved within a business day.</p>
    </PolicyLayout>
  ),
});
